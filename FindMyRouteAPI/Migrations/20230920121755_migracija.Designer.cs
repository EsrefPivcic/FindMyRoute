...
namespace FindMyRouteAPI.Migrations
{
    ...
    [Migration("20230920121755_migracija")]
            ...
            modelBuilder.Entity("FindMyRouteAPI.Modul.Models.Linija", b =>
                {
                    ...
                    b.Property<int?>("Grad1_id")
                        .HasColumnType("int");

                    b.Property<int?>("Grad2_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindMyRouteAPI.Modul.Models.Linija", b =>
                {
                    ...
                    b.HasOne("FindMyRouteAPI.Modul.Models.Grad", "Grad1")
                        .WithMany()
                        .HasForeignKey("Grad1_id");

                    b.HasOne("FindMyRouteAPI.Modul.Models.Grad", "Grad2")
                        .WithMany()
                        .HasForeignKey("Grad2_id");
